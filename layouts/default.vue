  ...
  <v-app :key="locale">
    <v-navigation-drawer v-model="drawer" app temporary width="256">
      <v-list nav dense>
        ...
        <v-list-item
          to="/supplyitem/supplyitem"
          link
          @click="closeDrawerOnMobile"
          prepend-icon="mdi-package-variant"
          :title="$t('menu.supply_item')"
          color="primary"
        />
        ...
        <v-list-group :value="$t('menu.estoque')">
          <template v-slot:activator="{ props }">
            <v-list-item
              v-bind="props"
              :title="$t('menu.estoque')"
              prepend-icon="mdi-package-variant-closed"
              color="primary"
            ></v-list-item>
          </template>
          <v-list-item
            to="/stock/checking/checking"
            link
            @click="closeDrawerOnMobile"
            :title="$t('menu.checking_supply')"
            color="primary"
          />
          <v-list-item
            to="/stock/movements/stock_movements"
            link
            @click="closeDrawerOnMobile"
            :title="$t('menu.stock_movements')"
            color="primary"
          />
        </v-list-group>
